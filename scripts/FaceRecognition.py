...
class FaceRecognition:
    ...
    def findFaces(self):
        ...
        for (top, right, bottom, left), name in zip(face_locations, face_names):
            ...
            face_msg = LabeledPoint()
            face_msg.point.x = int(cx)
            face_msg.point.y = int(cy)
            face_msg.label = name
            output_msg.points.append(face_msg)
    ...
    def run(self):
        ...
        #
        # obama_image = face_recognition.load_image_file(filepath + "obama.jpg")
        # print(glob.glob(filepath+"*.jpg"))
...
# amy_image = face_recognition.load_image_file("faces/amy.jpg")
